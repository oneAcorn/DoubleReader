...
import com.base.commonmodule.utils.download.DownloadProgressWatcher
...
//    }
    ...
    override fun onStart() {
        ...
        dialog?.window?.let {
            ...
            lp.width = (width.toFloat() * 0.8f).toInt()
            it.attributes = lp
        }
    }
...
//        okBtn.text = "下载中.."
        okBtn.setTextColor(context!!.resources.getColor(R.color.gray))
    ...
    private fun updateProgress(downloadId: Long?) {
        ...
        downloadWatcher = DownloadProgressWatcher(context!!, downloadId)
